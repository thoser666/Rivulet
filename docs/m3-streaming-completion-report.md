...
| F-M3-005 | Medium | VOD track | Per-track GStreamer routing into the muxed output (and routing UI) is not yet wired; configuration contract is complete. | M9 / streaming-UI follow-up (issue [#78](https://github.com/thoser666/Rivulet/issues/78)) | VOD audio lands in a separate track in the recording |
