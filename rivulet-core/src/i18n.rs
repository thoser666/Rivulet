    ...
    fn strings(self) -> &'static [(&'static str, &'static str)] {
        match self {
            Locale::En => &[
                ...
                ("eq_system", "System"),
                ("eq_microphone", "Mic"),
                // Multi-track audio routing (M6, issue #154 Phase 2)
                ...
                ("audio_source_kind_app", "Application"),
                ("audio_source_kind_input", "Input device"),
                ("audio_source_kind_output", "Output device"),
                ("audio_source_kind_mixed", "Mixed"),
                ("audio_routing_sources", "Audio sources"),
                ("audio_routing_record", "Record"),
                ("audio_routing_stream", "Stream"),
                ("audio_routing_hint", "Choose which outputs receive this source"),
                ("audio_routing_inline", "Sources"),
                ("audio_routing_legacy_active", "No routed sources — the legacy System/Microphone capture is active."),
                ("audio_source_pick_process", "Process"),
                ("audio_source_refresh_processes", "Refresh the process list"),
                ("audio_source_no_process_selected", "Select a process…"),
                ("audio_source_pid_required", "Select a process above — without it the source has no capture target."),
                ("audio_app_capture_failed", "Per-app audio capture for pid {0} failed: {1}"),
                ("audio_app_fallback_hint", "macOS: application sources share the system loopback mix — macOS has no per-app capture API."),
                ("audio_source_pick_device", "Device"),
                ("audio_source_refresh_devices", "Refresh the device list"),
                ("audio_source_no_device_selected", "Select a device…"),
                ("audio_source_default_device", "(default)"),
                ("audio_source_device_required", "Select a device above — without it the source falls back to the system default."),
                ("audio_device_capture_failed", "Device audio capture for {0} failed: {1}"),
                ("audio_source_output_device_loopback_hint", "macOS: an Output device needs a virtual loopback driver (BlackHole, Soundflower, Loopback, VB-Cable) — macOS cannot loop back a render endpoint."),
                ("audio_filter_per_source", "Filters for {0}"),
...
Discord Rich Presence. Never includes stream keys, URLs, paths or window titles."),
                ...
                ("global_issue_error", "Error"),
                ("global_issue_warning", "Warning"),
                ("global_issue_info", "Info"),
                (
                    "global_issue_jump_hint",
                    "Click to open the view this message belongs to.",
                ),
                ...
                ("chat_multi_hint", "Connects every configured platform account; messages from all of them appear combined below."),
                ("chat_account_add", "Add"),
                ...
                ("chat_state_off", "Off"),
                ("chat_info_title", "Stream info (title / category)"),
                ("chat_info_field_title", "Title:"),
                ("chat_info_hint_title", "New stream title"),
                ("chat_info_field_game", "Game / category:"),
                ("chat_info_hint_game", "Game or category name"),
                ("chat_info_apply_all", "Apply to all"),
                ("chat_info_scope_all", "All platforms"),
                ("chat_info_apply_platform", "Apply to {0}"),
                ("chat_info_busy", "Applying…"),
                ("chat_info_updated", "updated"),
                ("chat_info_nothing", "Enter a title or a game to apply."),
                ("chat_info_thread_failed", "Update failed (worker thread died)"),
                ...
                ("alerts_dock_title", "Alerts"),
                (
                    "alerts_dock_hint",
                    "Live list — follows, subs, donations and raids from all connected platforms in one place.",
                ),
                ...
                ("alert_raid_direction_out", "Raid out (I raid others)"),
                ("alert_raid_direction_in", "Raided (others raid me)"),
                ("alert_raid_direction_both", "Both directions"),
                ...
                ("composition_add", "Add"),
                ("composition_device_picker", "Device"),
                ("composition_device_default", "Default (automatic)"),
                ("composition_device_none", "No devices detected."),
                ("game_detection_running_marker", "running now"),
                ("composition_device_attached", "Source added with device \"{0}\"."),
                ...
                ("composition_copy", "Copy item"),
                ("composition_paste", "Paste item"),
                ("composition_copy_ok", "Scene item copied"),
                ("composition_paste_ok", "Scene item pasted"),
                ("composition_paste_empty", "Clipboard is empty — copy a scene item first"),
            ...
            Locale::De => &[
                ...
                ("audio_source_kind_app", "Anwendung"),
                ("audio_source_kind_input", "Eingabegerät"),
                ("audio_source_kind_output", "Ausgabegerät"),
                ("audio_source_kind_mixed", "Gemischt"),
                ("audio_routing_sources", "Audio-Quellen"),
                ("audio_routing_record", "Aufnahme"),
                ("audio_routing_stream", "Stream"),
                ("audio_routing_hint", "Wähle, welche Ausgaben diese Quelle erhalten"),
                ("audio_routing_inline", "Quellen"),
                ("audio_routing_legacy_active", "Keine gerouteten Quellen — die klassische System/Mikrofon-Aufnahme ist aktiv."),
                ("audio_source_pick_process", "Prozess"),
                ("audio_source_refresh_processes", "Prozessliste aktualisieren"),
                ("audio_source_no_process_selected", "Prozess auswählen…"),
                ("audio_source_pid_required", "Wähle oben einen Prozess — ohne ihn hat die Quelle kein Aufnahmeziel."),
                ("audio_app_capture_failed", "Prozess-Audio-Aufnahme für pid {0} fehlgeschlagen: {1}"),
                ("audio_app_fallback_hint", "macOS: Anwendungsquellen teilen sich die System-Loopback-Spur — macOS hat keine API für App-Audio-Aufnahme."),
                ("audio_source_pick_device", "Gerät"),
                ("audio_source_refresh_devices", "Geräteliste aktualisieren"),
                ("audio_source_no_device_selected", "Gerät auswählen…"),
                ("audio_source_default_device", "(Standard)"),
                ("audio_source_device_required", "Wähle oben ein Gerät — ohne es fällt die Quelle auf den System-Standard zurück."),
                ("audio_device_capture_failed", "Geräte-Audio-Aufnahme für {0} fehlgeschlagen: {1}"),
                ("audio_source_output_device_loopback_hint", "macOS: ein Ausgabegerät braucht einen virtuellen Loopback-Treiber (BlackHole, Soundflower, Loopback, VB-Cable) — macOS kann Render-Endpoints nicht zurückleiten."),
                ("audio_filter_per_source", "Filter für {0}"),
                ("audio_monitoring", "Monitoring"),
...
Discord Rich Presence. Enthält nie Stream-Keys, URLs, Pfade oder Fenstertitel."),
                ...
                ("global_issue_error", "Fehler"),
                ("global_issue_warning", "Warnung"),
                ("global_issue_info", "Info"),
                (
                    "global_issue_jump_hint",
                    "Klicken, um die Ansicht dieser Meldung zu öffnen.",
                ),
                ...
                ("chat_multi_hint", "Verbindet alle konfigurierten Plattform-Konten; Nachrichten von allen erscheinen unten kombiniert."),
                ("chat_account_add", "Hinzufügen"),
                ...
                ("chat_state_off", "Aus"),
                ("chat_info_title", "Stream-Info (Titel / Kategorie)"),
                ("chat_info_field_title", "Titel:"),
                ("chat_info_hint_title", "Neuer Stream-Titel"),
                ("chat_info_field_game", "Spiel / Kategorie:"),
                ("chat_info_hint_game", "Spiel- oder Kategoriename"),
                ("chat_info_apply_all", "Auf alle anwenden"),
                ("chat_info_scope_all", "Alle Plattformen"),
                ("chat_info_apply_platform", "Auf {0} anwenden"),
                ("chat_info_busy", "Wird angewendet…"),
                ("chat_info_updated", "aktualisiert"),
                ("chat_info_nothing", "Titel oder Spiel eingeben, um anzuwenden."),
                ("chat_info_thread_failed", "Aktualisierung fehlgeschlagen (Worker-Thread beendet)"),
                ("chat_oauth_label", "Token (optional)"),
                ("chat_oauth_hint", "oauth:..."),
                ("chat_token_hint_kick", "Kick-Session-Token (x-sess-token)"),
                ...
                (
                    "alerts_dock_hint",
                    "Live-Liste — Follows, Abos, Spenden und Raids aller verbundenen Plattformen an einem Ort.",
                ),
                ("alerts_dock_clear", "Leeren"),
                (
                    "alerts_dock_empty",
                ...
                ("alert_eventsub_raid_direction", "Raid-Alerts"),
                ("alert_raid_direction_out", "Raid raus (ich raidet andere)"),
                ("alert_raid_direction_in", "Geraidet (andere raiden mich)"),
                ("alert_raid_direction_both", "Beide Richtungen"),
                ...
                ("composition_device_picker", "Gerät"),
                ("composition_device_default", "Standard (automatisch)"),
                ("composition_device_none", "Keine Geräte gefunden."),
                ("game_detection_running_marker", "läuft gerade"),
                ("composition_device_attached", "Quelle mit Gerät \"{0}\" hinzugefügt."),
                ...
                ("composition_copy", "Element kopieren"),
                ("composition_paste", "Element einfügen"),
                ("composition_copy_ok", "Szenenelement kopiert"),
                ("composition_paste_ok", "Szenenelement eingefügt"),
                ("composition_paste_empty", "Zwischenablage ist leer — zuerst ein Szenenelement kopieren"),
