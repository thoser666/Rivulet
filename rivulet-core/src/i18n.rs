...
Discord Rich Presence. Never includes stream keys, URLs, paths or window titles."),
                ...
                ("chat_send_locked", "Sending requires an OAuth token (chat:send) and a connected chat."),
...
Discord Rich Presence. Enthält nie Stream-Keys, URLs, Pfade oder Fenstertitel."),
                ...
                ("chat_send_locked", "Zum Senden werden ein OAuth-Token (chat:send) und ein verbundener Chat benötigt."),
