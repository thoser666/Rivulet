...
Discord Rich Presence. Never includes stream keys, URLs, paths or window titles."),
                ...
                ("alert_note", "Follows, subs, gifted subs, donations and raids are ingested locally (provider webhooks) and shown in the chat dock. Purely local: nothing is transmitted and no token or secret is ever stored or logged. The network receiver is a planned follow-up."),
...
Discord Rich Presence. Enthält nie Stream-Keys, URLs, Pfade oder Fenstertitel."),
                ...
                ("alert_note", "Follows, Abos, Geschenk-Abos, Spenden und Raids werden lokal (Provider-Webhooks) erfasst und im Chat-Dock angezeigt. Rein lokal: es wird nichts übertragen und nie ein Token oder Secret gespeichert oder geloggt. Der Netzwerk-Empfänger ist ein geplanter Folgeschritt."),
