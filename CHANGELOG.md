...
## [0.65.0-alpha.242] - 2026-09-26
- feat(audio): build per-bus pipeline branches with live track masters (#242) (#245)
- feat(audio): per-track audio model — bus types, audio_tracks_v1, migration (#242) (#244)
- feat(logging): log redacted pipeline plus GStreamer domain/code on construction failure (#243)
- feat(game-capture): Steam game detection via local manifests (#239) (#240)
- feat(m7): add injectable engine clock with virtual PTS stamping (#187) (#238)
- feat(audio): add macOS Core Audio device capture for the Mixer (#231) (#237)
- feat(audio): add Linux PipeWire device capture for the Mixer (#231) (#236)
- fix(gui): colocate WebView2Loader.dll with the exe on every Windows build
- docs(readme): document the WebView2Loader.dll copy step for local GUI runs
- feat: real wry browser-source adapter with input forwarding and transparency (#227) (#228)
- feat(gui): live-refresh the per-app process picker while it is open
- feat(gui): live-refresh the WASAPI device picker while it is open
- feat(audio): WASAPI device capture for mixer Output/Input sources (#229) (#230)
- feat(m7): scene-item copy/paste with deterministic ids and paste-undo (#192) (#226)
- docs(m6.9): close the interim backlog milestone — README status, shipped #215 (#224)
- feat(m6.9): wry/WebView2 browser-source POC via CapturePreview (#215) (#223)
- M6.9: scene compositing, device picker, browser backend reference (#215, #216, #217) (#222)
- docs(readme): mark M6.9 per-platform stream metadata (#214) as shipped (#221)
- feat(m6.9): per-platform stream title/game drafts in the stream-info editor (#214) (#220)
- feat(obs-ws): add replay-buffer and studio-mode v5 actions for full Stream Deck coverage (#219)
- docs(m69): add interim backlog milestone for scene & stream polish (issues #214-#217) (#218)
- docs(guide): Stream Deck connection steps in the obs-websocket section (#213)
- fix(obs-ws): speak the real v5 wire names so Stream Deck plugins can drive Rivulet (#212)
- feat(alerts): per-source rate limiting with visible suppression notices (#210)
- feat(alerts): parse YouTube engagement events (Super Chats/Stickers/members) from the Innertube poll feed (#209)
- feat(alerts): parse Kick engagement events (subs/gifts) from the Pusher chat stream (#208)
- feat(alerts): make the raid alert direction configurable (out/in/both) (#207)
- test(chat): pin shared-chat reply threading to the joined room's delivery id (#206)
- feat(chat): resolve shared-chat room ids to channel logins via cached Helix lookup (#205)
- fix(alerts): use the directional from_broadcaster_user_id raid condition (#204)
- feat(chat): attribute Twitch Shared Chat messages by source room (#203)
- ci(security): daily PAT expiry guard for SCOOP_BUCKET_TOKEN (#202)
- docs(winget): design the automated winget-pkgs submission flow (#201)
- packaging(aur): bump PKGBUILD to 0.65.0.alpha.208 with real checksums (#200)
- test(pinning): require a git identity in every weekly-promotion committing step (#199)
- docs(user-guide): document the stream-info editor in the combined chat dock (#198)
- feat(chat): stream-info editor in the combined dock (#197)
- ci: bump codeql-action pins v4.38.0 -> v4.38.1 (#196)
- ci(release): delete temporary release branch after a successful release (#195)
- feat(cli): headless rivulet-cli MVP with record subcommand (issue #186) (#194)
- docs(m7): spec and workstream issues for the Automation & Determinism milestone (#193)
- docs(m6): track F-M6-001/002 live-evidence follow-ups (#182/#183) (#184)
- core(stream): mark streaming FLV mux stage for active VodTrack (issue #78) (#185)
- docs: document global status surface and sync stale repo docs with the wiki (#181)
- feat(gui): VOD track settings UI for the streaming view (issue #78) (#180)
- feat(core): VOD track third audio branch in dual-output recording (issue #78) (#179)
- ci(guard): extend apt package parity to all workflows (#178)
- a11y(ui): enforce WCAG 2.5.8 minimum target size (ui-008) (#177)
- a11y(ui): honor prefers-reduced-motion (WCAG 2.3.3, ui-005) (#176)
- ci(guard): enforce apt package parity between ci.yml and nightly.yml (#175)
- a11y(ui): global status surface in the sidebar footer (ui-007) (#174)
- fix(ci): nightly is green again — alsa deps, drifted pins, tag regex (#173)
- a11y(ui): WCAG-AA button states and widget-contrast CI gate (#172)
- feat(ui): re-enable AccessKit and confirm destructive actions (#171)
- docs(user-guide): describe combined chat dock and OS-vault account model (#170)
- docs(m6): creator toolkit completion report and milestone close (#168)
- fix(test): poll EventSub stats until subscriptions are created (#169)
- fix(test): arm EventSub API stub deadline on first request (#167)
- feat(alerts): combined alerts dock — one live list for all platforms (#166)
- feat(chat): combined multi-platform chat dock — one list, one send box (#164)
- fix(ci): weekly promotion sets a git identity before tagging (#165)
- feat(m10): sound/voice generation track for the AI Creative Studio (#162)
- test(resources): M6 resource report — 6 routed sources with full filter chains within budget (#161)
- feat(audio): macOS system-loopback per-app fallback (Phase 5 of #154) (#160)
- feat(audio): Linux PipeWire per-app audio capture backend (Phase 4 of #154) (#158)
- feat(audio): WASAPI per-application capture backend (Phase 3, #154) (#157)
- feat(gui): multi-track audio routing mixer (M6 #154 Phase 2) (#156)
- feat(audio): multi-track audio routing engine core (M6, #154 Phase 1) (#155)
- docs(roadmap): M6 status to In progress with per-criterion gate notes (#153)
- feat(telemetry): emit SceneSwitch, ChatConnect and RecordingError events (#152)
- docs(m10): AI settings placement — Settings page + Assistant tab (closes #149) (#151)
- docs(roadmap): close M5 with honest annotations (#150)
- docs(roadmap): M5 descope annotations — OBS-compat to M11, honest blockers (#148)
- feat(plugins): Phase 3 capability approval + install flow (registry + GUI) (#146)
- ci(distribution): prepare every active channel once per week from weekly-latest (#145)
- feat(plugins): complete Phase 2 WASM plugin runtime (wasmtime sandbox + lifecycle) (#142)
- spike(m10): code-gen model spike — qwen2.5-coder:7b default, harness + artifacts (#144)
- docs(m10): AI Creative Studio (Spark-like) roadmap acceptance + off-switches (#143)
- feat(distribution): AUR PKGBUILD for Arch Linux (#140)
- feat(obs/ws): mobile & HTTP remote companion for LAN scenes/record/stream (M6) (#141)
- feat(alerts): native outbound Twitch EventSub WebSocket transport (M5) (#139)
- Weekly release promotion (fast lane / slow lane) (#138)
- feat(alerts): opt-in loopback webhook receiver (M5) (#132)
- feat(distribution): Flathub Stage 2 preparation (M5) (#135)
- feat(distribution): Scoop bucket for Rivulet (no signing required) (#137)
- chore(signing): paste-in SignPath artifact configuration XML (#136)
- feat(distribution): WinGet Stage 2 preparation (M5) (#134)
- docs(roadmap): mark global hotkeys, Discord RP and chat dock (M5) Done (#133)
- feat(alerts): native chat-dock alert ingestion (M5) (#130)
- docs(signing): record SignPath Foundation application as submitted (#131)
- feat(telemetry): M5 opt-in, privacy-first usage telemetry (#128)
- docs(signing): add ready-to-submit SignPath Foundation application draft (#126)
- feat(wiki): Spanish as third wiki language + topic report in wiki job (#125)
- feat(signing): SignPath Foundation Windows signing path (#50) (#124)
- feat(signing): Linux GPG signing and maintainer setup doc (#50) (#123)
- docs(vst3): Z96-4 hosting contract, platform matrix, and gating (#122)
- feat(docs): auto-derive user-guide topics from GUI i18n keys (#121)
- feat(docs): doc-freshness enforcement for wiki and user manual (#120)
- feat(vst3): host-boundary skip-path tests (Z96-3) (#118)
- feat(vst3): Windows COM host skeleton (Z96-2) with boundary tests (#117)
- feat(gui): source delete hotkey (M5 OBS 32.2 parity) (#113) (#114)
- feat(M6 + Z96-1): restream, auto-clips, VST3 host boundary (#116)
- feat(i18n): complete multi-language support (M5) (#115)
- docs(issues): decompose #78 and #96 into subtasks (#111)
- fix(security): resolve the open code-scanning alerts (#112)
- build(ci): bump the Windows GStreamer runtime pin to 1.28.6 (#108, #109) (#110)
- build(ci): prepare the Windows GStreamer provisioning for the 1.28 installer generation (#109)
- build(deps): upgrade the Windows CI GStreamer runtime 1.24.13 to 1.26.11 (#108)
- fix(release): audit all softprops files lists for duplicate/overlapping uploads (#107)
- fix(release): attach SHA256SUMS exactly once (#106)
- feat(ossf): close the remaining silver-tier repo-side gaps + monitor/window pick fix + coverage-gate root fixes (#105)
- docs(ossf): close the silver-tier repo-side gaps (#104)
- ci(security): per-PR Ruleset Guard proves develop blocks direct pushes (#103)
- ci(ossf): add metal-series passing claims to .bestpractices.json (#102)
- ci(ossf): close the three baseline-1 gaps (#101)
- ci(pinning): guard the OpenSSF .bestpractices.json schema
- fix(gui): expose rivulet-audio to macOS target and import audio types
- fix(audio): target the cpal 0.15.3 stream API on macOS
- docs(contributing): OpenSSF passing-badge policies (review, done, release)
- fix(audio): macOS cpal backend compile errors
- feat(audio): macOS audio capture for the recording pipeline
- test(macos): arm a real engine session in the background-stop test
- fix(macos): make the new macOS recording path compile on macOS
- feat(record): macOS screen/window recording (M5 platform parity)
- refactor(streaming): remove the legacy FFmpeg encoder crate
- feat(streaming): NDI output as a selectable destination (M5 #77)
- fix(ci): qualify the alpha release-branch push destination
- feat(ci): weekly OBS check also reviews Rivulet open issues as a review issue
- fix(gui): streaming stop is non-blocking and cannot leak a session
- feat(gui): visible stop finalization status
- fix(gui): non-blocking recording stop (issue: UI freeze)
- build(deps): bump tokio from 1.49.0 to 1.50.0 (#87)
- build(deps): bump tracing-subscriber from 0.3.22 to 0.3.23 (#85)
- ci(release): gate the alpha release on CI conclusion with auto-resume
- ci(hooks): guard pre-push hook shell syntax with bash -n
- ci(hooks): add optional fast-guard stage to the pre-push hook
- ci(hooks): committed pre-push hook mirrors the CI Lints job
- feat(chat): reply-banner tests, responsive send budget + tooltip, Windows-safe fixtures
- feat(gui): show the live chat send budget above the input
- test(gui): cover the threaded chat reply path with behavior tests
- feat(chat): threaded Twitch replies and phone-verification notice
- ci(pinning): guard the M10 platform-compliance bullets in both docs
- feat(chat): shared per-platform outbound rate limiter
- docs(roadmap): add M10 platform-compliance requirements
