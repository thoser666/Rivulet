...
**Status: In progress** (3 of 4 features shipped — chat auto-clips, multi-platform restream, and the mobile/HTTP remote companion are done and their issues closed; multi-track audio routing is the remaining item, designed in [`docs/m6-audio-routing.md`](docs/m6-audio-routing.md))
